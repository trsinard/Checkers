...
public class Random {
	...
	public int randomInt(int low, int high) {
		// rand.nextInt(num) returns a number between 0 (inclusive) and num - 1
		// (inclusive)
		// range initially is 0 to high - low (inclusive)
		// to correct the range, add low to the result to get low to high
		// (inclusive of both)
	...
	public double randomFloat(int low, int high) {
		// rand.nextDouble gives a number between 0.0 (inclusive) and 1.0
		// (exclusive)
		// randomFloat then gives a number between low (inclusive) and high
		// (exclusive)
