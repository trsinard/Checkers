 ...
 */
public class ScoreBoard implements Drawable, GameStateListener<CheckersGame> {
	 ...
	 * <b>Postconditions:</b> Changes the drawn image of score-board based on
	 * turn, and updates the score to be drawn. Nothing is changed if received
	 * game is null. <b>Throws:</b> None
	 */
	@Override
	...
	/**
	 * Gets and returns score-board image. <b>Preconditions:</b> None
	...
	/**
	 * Gets and returns score for player 1. <b>Preconditions:</b> None
	 * <b>Postconditions:</b> Returns value of player 1 score. <b>Throws:</b>
	 * None
	 */
	...
	/**
	 * Gets and returns score for player 2. <b>Preconditions:</b> None
	 * <b>Postconditions:</b> Returns value of player 2 score. <b>Throws:</b>
	 * None
	 */
	 ...
	 * score-board's original dimension. <b>Throws:</b> None
	 */
	...
	/**
	 * Gets and returns score-board image new dimension. <b>Preconditions:</b>
	 * None <b>Postconditions:</b> Returns reference to score-board's rescaled
	 * dimension <b>Throws:</b> None
	 */
	...
	/**
	 * Method to get the layer priority <b>Preconditions:</b> None
	 * <b>Postconditions:</b> Returns layer priority <b>Throws:</b> None
	 */
	@Override
	public int getZ() {
		return layerZ;
	...
	/**
	 * Method to apply the images and draw the graphics. <b>Preconditions:</b>
	 * None <b>Postconditions:</b> Draws score-board and data <b>Throws:</b>
	 * None
	 */
	@Override
	public void draw(Graphics2D g, ScreenData sd) {
		...
		if (scoreBoardImage != null) {
			...
			scaledHeight = (int) Math.round(scoreBoardImage.getHeight()
					* sd.getScaleRatio());
			// Create new size
			this.newSize = new Dimension((Math.round(scaledWidth)),
			...
			// Image offsets from one's and ten's position. Half-size scaled to
			// ratio
	 ...
	 * <b>Postconditions:</b> Returns new array with digits split, 0 and 99
	 * being bounds. <b>Throws:</b> None
	 */
